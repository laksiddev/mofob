...
{
    [MessageContract(IsWrapped = true, WrapperName = "TestTransactionRequestMessage", WrapperNamespace = "http://mof.open/MessagingTests/MessageContracts/1/0/")]
    [MessageTransactionBehavior(SupportsTransactions = true, RequiresTransactions = true)]
    [TwoWayResponseMessageType(typeof(TestTransactionResponseMessage))]
