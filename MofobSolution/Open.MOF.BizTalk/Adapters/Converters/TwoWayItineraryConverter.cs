...
{
    public class TwoWayItineraryConverter : System.ComponentModel.TypeConverter
    {
        private const string _constResponseMessageExchangePattern = "Request-Response";
        private const bool _constIsRequestResponse = true;
