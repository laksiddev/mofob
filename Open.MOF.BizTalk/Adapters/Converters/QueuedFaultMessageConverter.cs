...
{
    public class QueuedFaultMessageConverter : System.ComponentModel.TypeConverter
    {
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            if (value.GetType() == typeof(Open.MOF.Messaging.FaultMessage))
            {
                ...
                Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage proxyFaultMessage = new Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage();

                // Fault Message Header
                proxyFaultMessage.Header = new Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessageHeader();
                ...
                proxyFaultMessage.ExceptionObject = new Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessageExceptionObject();
