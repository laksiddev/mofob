...
namespace Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://microsoft.biztalk.practices.esb.com/exceptionhandling/", ConfigurationName = "MOF.BizTalkESB.Queued.IExceptionHandling", ProtectionLevel = System.Net.Security.ProtectionLevel.None)]
    internal interface IExceptionHandling
    {
        ...
        void SubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest request);

        [System.ServiceModel.OperationContractAttribute(AsyncPattern = true, Action = "SubmitFault", IsOneWay = true)]
        System.IAsyncResult BeginSubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest request, System.AsyncCallback callback, object asyncState);

        void EndSubmitFault(System.IAsyncResult result);
    }
    ...
    internal partial class SubmitFaultRequest
    {
        ...
        public Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage;
        
        public SubmitFaultRequest()
        {
        }

        public SubmitFaultRequest(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    internal interface ExceptionHandlingChannel : Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    internal partial class ExceptionHandlingClient : System.ServiceModel.ClientBase<Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling>, Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling
    {
        ...
        void Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling.SubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest request)
        {
            base.Channel.SubmitFault(request);
        }

        public void SubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage)
        {
            Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest inValue = new Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest();
            inValue.FaultMessage = FaultMessage;
            //Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultResponse retVal = ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.ExceptionHandling)(this)).SubmitFault(inValue);
            ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling)(this)).SubmitFault(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling.BeginSubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest request, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginSubmitFault(request, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginSubmitFault(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage, System.AsyncCallback callback, object asyncState)
        {
            Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest inValue = new Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultRequest();
            inValue.FaultMessage = FaultMessage;
            return ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling)(this)).BeginSubmitFault(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling.EndSubmitFault(System.IAsyncResult result)
        {
            base.Channel.EndSubmitFault(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public void EndSubmitFault(System.IAsyncResult result)
        {
            //Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.SubmitFaultResponse retVal = ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.ExceptionHandling)(this)).EndSubmitFault(result);
            ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.IExceptionHandling)(this)).EndSubmitFault(result);
        }
        
        private System.IAsyncResult OnBeginSubmitFault(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage = ((Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage)(inValues[0]));
        ...
        public void SubmitFaultAsync(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage)
        {
            this.SubmitFaultAsync(FaultMessage, null);
        }

        public void SubmitFaultAsync(Open.MOF.BizTalk.Adapters.Proxy.Queued.EsbExceptionServiceInstance.FaultMessage FaultMessage, object userState)
        {
